...
class options{
    ...
    divAdd(){
        ...
        //div.className = 'divadd'; //даем элементу класс
/*  через style задаем стили
        div.style.height = this.height + 'px';
        div.style.width = this.width + 'px';
        div.style.backgroundColor = this.bg;
        div.style.fontSize = this.fontSize + 'em';
...
*/
        ...
        div.textContent = this.textAlign;
...
let div = new options(50, 500, 'red', '3', 'Привет класс ES6');
